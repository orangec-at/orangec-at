      ...
      <section className="space-y-5">
        ...
        <div className="grid gap-3 md:grid-cols-2">
          <article className="rounded-xl border border-border bg-card p-4 text-small text-muted-foreground">
            {ABOUT_CONTENT.availability.type}
          </article>
          <article className="rounded-xl border border-border bg-card p-4 text-small text-muted-foreground">
            {ABOUT_CONTENT.availability.start}
          </article>
          <article className="rounded-xl border border-border bg-card p-4 text-small text-muted-foreground">
            {ABOUT_CONTENT.availability.timezone}
          </article>
          <article className="rounded-xl border border-border bg-card p-4 text-small text-muted-foreground">
            {ABOUT_CONTENT.availability.style}
          </article>
        </div>
      </section>
