...
export default function BlogPostClient({
  ...
  return (
    <div className="min-h-screen bg-transparent prevent-horizontal-scroll">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12 max-w-5xl w-full prevent-horizontal-scroll">
        ...
        <div className="muji-panel p-5 sm:p-7 lg:p-8">
          {/* Blog Header */}
          {blogMeta && (
            <div className="mb-8 sm:mb-12 pb-6 sm:pb-8 border-b border-gray-200/70 dark:border-gray-700">
          ...
          prose-a:text-wood-700 dark:prose-a:text-wood-300 prose-a:no-underline hover:prose-a:underline prose-a:break-words
          prose-strong:text-gray-900 dark:prose-strong:text-white
          prose-code:text-wood-700 dark:prose-code:text-wood-300 prose-code:break-words
          prose-pre:bg-transparent prose-pre:p-0 prose-pre:overflow-x-auto prose-pre:max-w-full
          prose-blockquote:border-l-wood-400 prose-blockquote:text-gray-600 dark:prose-blockquote:text-gray-400
