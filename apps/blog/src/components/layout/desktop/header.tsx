...
export default function DesktopHeader() {
  ...
  return (
    <header
      className={`
        hidden md:flex items-center mx-auto
        fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-out
        ${
          isScrolled
            ? "max-w-fit rounded-full mt-4 py-3 px-4 md:px-6 bg-white/80 backdrop-blur-md shadow-lg justify-center gap-4 md:gap-6"
            : "max-w-2xl lg:max-w-4xl mt-4 py-3 rounded-full px-4 md:px-6 bg-white/60 backdrop-blur-md shadow-lg border-t border-gray-100 justify-between"
        }
      `}
    >
      <div className="flex items-center gap-4">
        ...
        >
          <Image
            ...
            className="md:w-8 md:h-8 transition-all duration-500 ease-out rounded-full"
          />
        </Link>
      </div>
